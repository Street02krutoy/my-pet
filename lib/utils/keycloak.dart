...
import 'package:my_pet/screens/subscreens/login.dart';
import 'package:openid_client/openid_client_io.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:url_launcher/url_launcher_string.dart';

class Keycloak {
  static Widget oldLoginButton = IconButton(
      onPressed: () {
        // Keycloak.authenticate();
      },
      icon: const Icon(Icons.login_sharp));

  static loginButton(BuildContext context) {
    return IconButton(
        onPressed: () {
          Navigator.push(
            context,
...
class Auth {
  ...
  static void set(String newToken) {
    token = newToken;
  }
}
